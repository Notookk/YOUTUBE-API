            ...
            <div class="col-lg-8">
                ...
                <div class="endpoint">
                    ...
                    <ul>
                        ...
                        <li><code>api_key</code> - Your API key (use <code>xotik</code> for testing)</li>
                    </ul>
                    <div class="example">
                        <h5><i class="fas fa-code me-2"></i>Example:</h5>
                        <pre>/youtube?query=295&video=false&api_key=xotik</pre>
                    </div>
                </div>
                ...
                <pre class="response-example p-4">
{
  ...
  "stream_type": "Audio"
        ...
        <div class="credit">
            <p class="mb-0">Developed by <a href="https://t.me/xazoc" target="_blank"><i class="fab fa-telegram"></i> @xazoc</a></p>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            testApiBtn.addEventListener('click', function() {
                ...
                const apiUrl = `/youtube?query=${encodeURIComponent(url)}&video=${isVideo}&api_key=xotik`;
